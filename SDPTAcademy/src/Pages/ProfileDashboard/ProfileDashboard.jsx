        ...
        <div className="row cards-container">
          ...
          <div className='col col-md-4 col-sm-12'> 
            <div className="card card-design profile-card text-white text-center align-items-center justify-content-center">
              <div className="content pt-3 mb-3"><h2>Profile Picture</h2></div>
          ...
          {/* Account Details */}
          <div className="col card card-design account-card text-white text-left">
            <div className="content pt-3 mb-5 mt-2 ms-4"> <h2>Account Details</h2></div>
